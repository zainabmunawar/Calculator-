Public Class Form1
    ...
    Private Sub Button7_Click(sender As Object, e As EventArgs) Handles Button10.Click
        If TextBox1.Text <> "0" Then
            TextBox1.Text += "5"
        Else
            TextBox1.Text = "5"
    ...
    Private Sub Button12_Click(sender As Object, e As EventArgs) Handles Button9.Click
        If TextBox1.Text <> "0" Then
            TextBox1.Text += "7"
        Else
            TextBox1.Text = "7"
    ...
    Private Sub Button16_Click(sender As Object, e As EventArgs) Handles Button15.Click
        If TextBox1.Text <> "0" Then
            TextBox1.Text += "0"
        End If
    End Sub
    ...
    Private Sub Button15_Click(sender As Object, e As EventArgs) Handles Button3.Click
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button18.Click
    ...
    Private Sub Button14_Click(sender As Object, e As EventArgs) Handles Button13.Click
        FirstNumber = TextBox1.Text
        TextBox1.Text = "0"
        Operator_selector = True
        Operations = 4 ' = /
